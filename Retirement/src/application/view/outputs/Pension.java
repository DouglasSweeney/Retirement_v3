...
/**
 * Creates the GUI tab for the Pension results.
 * 
 * @author Doug Sweeney
 * @version     1.0
 * @since       1.0
 */
public class Pension extends OutputObject {
...
//  public static List<ResultsDataNode> values;
  ...
  private void writeHeaders() {
    LOGGER.trace("Entering the Pension writeHeaders().");
    ...
    LOGGER.trace("Leaving the Pension writeHeaders().");
  }
  ...
  private void writeData(final ResultsDataNode node) {
    LOGGER.trace("Entering the Pension writeData().");
    ...
    LOGGER.trace("Leaving the Pension writeData().");
  }
  ...
  public void writeListOfData(final List<ResultsDataNode> values) {
    LOGGER.trace("Entering the Pension writeListOfData().");
    ...
    LOGGER.trace("Leaving the Pension writeListOfData().");
  }
   ...
   */
  public void clear() {
    LOGGER.trace("Entering the Pension clear().");
  ...
  public void writePdf2(final PDDocument doc) {
    ...
    if (getList().size() > CreatePdf.LIST_SIZE_PER_PAGE) {
      ...
      try (PDPageContentStream contents2 = new PDPageContentStream(doc, page2)) {
        ...
        LOGGER.error("Received an error in Pension writePdf2()");
      }
    }
  }
}
