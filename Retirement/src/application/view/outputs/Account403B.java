...
/**
 * Creates the GUI tab for the Account403B results.
 * 
 * @author Doug Sweeney
 * @version     1.0
 * @since       1.0
 */
public class Account403B extends OutputObject {
  /**
   * 
   */
...
//  public static List<ResultsDataNode> values;
  ...
  /** 
   * Get the data for the 403B account.
   * 
   * @since  1.0
   */
  public Account403B() {
    ...
    LOGGER.trace("Called the Account403B constructor.");
  ...
  public JPanel createPanel() {
    LOGGER.trace("Entering the Account403B createPanel() with no parameters.");
    ...
    LOGGER.trace("Leaving the Account403B createPanel().");
  ...
  public String getName() {
    LOGGER.trace("Entering the Account403B getName() with no parameters.");
  ...
  private void writeHeaders() {
    LOGGER.trace("Entering the Account403B writeHeaders().");
    ...
    LOGGER.trace("Leaving the Account403B writeHeaders().");
  }
  ...
  private void writeData(final ResultsDataNode node) {
    LOGGER.trace("Entering the Account403B writeData().");
    ...
    LOGGER.trace("Leaving the Account403B writeData().");
  }
  ...
  public void writeListOfData(final List<ResultsDataNode> values) {
    LOGGER.trace("Entering the Account403B writeListOfData().");
    ...
    LOGGER.trace("Leaving the Account403B writeListOfData().");
  }
   ...
   */
  public void clear() {
    LOGGER.trace("Entering the Account403B clear().");
        
    textArea2.setText(null);
      
    LOGGER.trace("Leaving the Account403B clear().");
  }
