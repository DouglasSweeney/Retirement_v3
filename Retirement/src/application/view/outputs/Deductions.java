...
/**
 * Creates the GUI tab for the annual deductions results.
 * 
 * @author Doug Sweeney
 * @version     1.0
 * @since       1.0
 */
public class Deductions extends OutputObject {
  /**
   * 
   */
  ...
  private void writeHeaders() {
    LOGGER.trace("Entering the Deductions writeHeaders().");
        
    textArea.append(String.format("%5.5s%8.8s%21.21s%18.18s\n", 
                                       "Year", 
                                        "Age", 
                                        "Beginning Deductions", 
                                        "Ending Deductions"));
        
    LOGGER.trace("Leaving the Deductions writeHeaders().");
  }
  ...
  private void writeData(final ResultsDataNode node) {
    ...
    LOGGER.trace("Leaving the Deductions writeData().");
  }
  ...
  public void writeListOfData(final List<ResultsDataNode> values) {
    LOGGER.trace("Entering the Deductions writeListOfData().");
    ...
    LOGGER.trace("Leaving the Deductions writeListOfData().");
  }    
   ...
   */
  public void clear() {
    LOGGER.trace("Entering the Deductions clear().");
