...
/**
 * Creates the GUI tab for the Savings results.
 * 
 * @author Doug Sweeney
 * @version     1.0
 * @since       1.0
 */
public class Savings extends OutputObject {
  /**
   * 
   */
...
//  public static List<ResultsDataNode> values;
  ...
  /** 
   * Get the data for the Savings account.
   * 
   * @since  1.0
   */
  public Savings() {
  ...
  public String getName() {
    ...
    LOGGER.trace("Leaving the Savings getName().");
  ...
  private void writeHeaders() {
    LOGGER.trace("Entering the Savings writeHeaders().");
    ...
    LOGGER.trace("Leaving the Savings writeHeaders().");
  }
  ...
  private void writeData(final ResultsDataNode node) {
    LOGGER.trace("Entering the Savings writeData().");
    ...
    LOGGER.trace("Leaving the Savings writeData().");
  }
  ...
  public void writeListOfData(final List<ResultsDataNode> values) {
    LOGGER.trace("Entering the Savings writeListOfData().");
    ...
    LOGGER.trace("Leaving the Savings writeListOfData().");
  }
   ...
   */
  public void clear() {
    LOGGER.trace("Entering the Savings clear().");
        
    textArea2.setText(null);
      
    LOGGER.trace("Leaving the Savings clear().");
  }
